...
class Step
{
    ...
    public function checkPattern()
    {
        ...
        if (!$dbPattern->isValidPattern($this->step['pattern_type'], $this->step['pattern'])) {
            throw new Exception(Piwik::translate('Funnels_ErrorPatternInvalidFormat', $this->step['pattern']));
        }
    }

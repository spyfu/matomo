...
class Archiver extends \Piwik\Plugin\Archiver
{
    ...
    protected function aggregateDayEvents()
    {
        $select = "
				...
				count(*) * 10 as `" . Metrics::INDEX_EVENT_NB_HITS . "`,
				...
				) * 10 as `" . Metrics::INDEX_EVENT_SUM_EVENT_VALUE . "`,
				sum( case when " . Action::DB_COLUMN_CUSTOM_FLOAT . " is null then 0 else 1 end ) * 10
